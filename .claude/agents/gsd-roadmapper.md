...
Reference full template: `/workspaces/sandbox/.claude/get-shit-done/templates/roadmap.md`

## STATE.md Structure

Use template from `/workspaces/sandbox/.claude/get-shit-done/templates/state.md`.
