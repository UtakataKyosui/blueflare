...
<!-- For checkpoint task examples and patterns, see @/workspaces/sandbox/.claude/get-shit-done/references/checkpoints.md -->
...
See `/workspaces/sandbox/.claude/get-shit-done/references/tdd.md` for TDD plan structure.
...
See `/workspaces/sandbox/.claude/get-shit-done/templates/user-setup.md` for full schema and examples
...
See `/workspaces/sandbox/.claude/get-shit-done/workflows/verify-phase.md` for verification logic.
