...
function Calendar({
  ...
  return (
    <DayPicker
      ...
      className={cn(
        "group/calendar w-full bg-background p-3 [--cell-radius:var(--radius-md)] [--cell-size:--spacing(10)] sm:[--cell-size:--spacing(11)] md:[--cell-size:--spacing(12)] lg:[--cell-size:--spacing(14)] in-data-[slot=card-content]:bg-transparent in-data-[slot=popover-content]:bg-transparent",
      ...
      classNames={{
        ...
        week: cn("mt-2 grid grid-cols-7 w-full justify-items-center", defaultClassNames.week),
